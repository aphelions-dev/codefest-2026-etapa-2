...
const AGENTS: Record<string, { readonly name: string; readonly role: string; readonly icon: LucideIcon }> = {
  ...
  visualizer: { name: "Generador de visualizaciones", role: "Elige qué componentes del tablero responden la pregunta", icon: ChartAreaIcon },
...
const TOOL_LABEL: Record<string, string> = {
  ...
  // Las del visualizador: el nombre de la herramienta es el componente que abre.
  get_places: "Mapa",
  get_timeline: "Línea de tiempo",
  get_entity_matrix: "Matriz de calor",
  get_cooccurrence: "Red de entidades",
